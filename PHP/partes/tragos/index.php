<?php 
    ...
    if(isset($_GET["numeroID"])){
        ...
        $sentencia = $conexion->prepare("SELECT foto FROM tabla_tragos WHERE id=:id");
        ...
        $sentencia = $conexion->prepare("DELETE FROM tabla_tragos WHERE id=:id");
        $sentencia->bindValue("id",$numeroID);
        $sentencia->execute();
    ...
    $sentencia = $conexion->prepare("SELECT * FROM tabla_tragos");
...
<table class="table">
    ...
    <tbody>
        ...
        <br>
            ...
            <br>
            <img width="150" src="./IMG/<?php echo $productos['foto']; ?>" alt="foto de productos">
            <br>
