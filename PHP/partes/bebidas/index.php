<?php 
    ...
    if(isset($_GET["numeroID"])){
        ...
        $sentencia = $conexion->prepare("DELETE FROM tabla_botella WHERE id=:id");
        $sentencia->bindValue("id",$numeroID);
        $sentencia->execute();
    ...
    $sentencia = $conexion->prepare("SELECT * FROM tabla_botella");
...
<table class="table">
    ...
    <tbody>
        ...
        <br>
            ...
            <br>
            <img width="80" src="./IMG/<?php echo $productos['foto']; ?>" alt="foto de productos">
            <br>
