<?php 
    ...
    if(isset($_GET["numeroID"])){
        ...
        $sentencia = $conexion->prepare("SELECT foto FROM tabla_combos WHERE id=:id");
        ...
        $sentencia = $conexion->prepare("DELETE FROM tabla_combos WHERE id=:id");
        $sentencia->bindValue("id",$numeroID);
        $sentencia->execute();
    ...
    $sentencia = $conexion->prepare("SELECT * FROM tabla_combos");
